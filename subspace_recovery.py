...
def recover_subspaces_from_file(sample_file, s, output_folder, start=0, J=None, cov_proj=True, matlab_name='Y'):
    """
    ...
    :param start: Starting index for recovery. If not set, starts at 0.
    :param J: Number of subspaces to recover. If not set, all will be recovered.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--start', type=int, help='Starting index', required = False, default=0)
